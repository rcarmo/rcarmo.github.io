...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 720 188">
  ...
  <text x="360" y="56" text-anchor="middle" class="label">Canvas API</text>
  <text x="360" y="74" text-anchor="middle" class="sub">draw · fill · text</text>

  <rect x="270" y="118" width="180" height="60" rx="8" class="box-warm"/>
  <text x="360" y="144" text-anchor="middle" class="label">PNG encoder</text>
  <text x="360" y="162" text-anchor="middle" class="sub">zlib · struct</text>

  <rect x="510" y="30" width="180" height="60" rx="8" class="box-orange"/>
  <text x="600" y="56" text-anchor="middle" class="label">.png file</text>
  <text x="600" y="74" text-anchor="middle" class="sub">any fileobj</text>
