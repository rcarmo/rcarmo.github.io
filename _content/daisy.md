...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 780 120">
  ...
  <rect x="290" y="30" width="180" height="60" rx="8" class="box-indigo"/>
  <text x="380" y="56" text-anchor="middle" class="label">Copilot</text>
  <text x="380" y="74" text-anchor="middle" class="sub">code generation</text>

  <rect x="550" y="30" width="180" height="60" rx="8" class="box-accent"/>
  <text x="640" y="56" text-anchor="middle" class="label">SwiftUI</text>
  <text x="640" y="74" text-anchor="middle" class="sub">treemap app</text>
