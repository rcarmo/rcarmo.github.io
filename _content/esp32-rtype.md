...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 960 202">
  ...
  <text x="120" y="56" text-anchor="middle" class="label">Main CPU ROM</text>
  <text x="120" y="74" text-anchor="middle" class="sub">flash partition</text>

  <rect x="30" y="118" width="180" height="60" rx="8" class="box-rose"/>
  <text x="120" y="144" text-anchor="middle" class="label">Graphics ROMs</text>
  <text x="120" y="162" text-anchor="middle" class="sub">SPI flash</text>
  ...
  <text x="360" y="74" text-anchor="middle" class="sub">CPU + memory map</text>

  <rect x="270" y="118" width="180" height="60" rx="8" class="box"/>
  <text x="360" y="144" text-anchor="middle" class="label">M72 RAM</text>
  <text x="360" y="162" text-anchor="middle" class="sub">sparse PSRAM regions</text>
  ...
  <text x="840" y="56" text-anchor="middle" class="label">RGB panel</text>
  <text x="840" y="74" text-anchor="middle" class="sub">scaled 720x480 at 40,0</text>

  <path d="M210,60 L270,60" fill="none" stroke="#3b82f6" stroke-width="1.5" stroke-linecap="round" marker-end="url(#ahs)"/>
  <path d="M210,148 L346,148 Q360,148 360,134 L360,74 Q360,60 374,60 L510,60" fill="none" stroke="#5070a0" stroke-width="1.5" stroke-linecap="round" marker-end="url(#ah)"/>
  <path d="M360,178 L360,30" fill="none" stroke="#5070a0" stroke-width="1.5" stroke-linecap="round" marker-end="url(#ah)"/>
  ...
  <text x="480" y="198" text-anchor="middle" class="sub">R-Type ROM layout and video path on ESP32-S3</text>
</svg>
