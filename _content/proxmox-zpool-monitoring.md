...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 720 188">
  ...
  <text x="360" y="56" text-anchor="middle" class="label">zpool status</text>
  <text x="360" y="74" text-anchor="middle" class="sub">parse output</text>

  <rect x="510" y="30" width="180" height="60" rx="8" class="box-rose"/>
  <text x="600" y="56" text-anchor="middle" class="label">Graphite</text>
  <text x="600" y="74" text-anchor="middle" class="sub">metrics push</text>

  <rect x="510" y="118" width="180" height="60" rx="8" class="box-accent"/>
  <text x="600" y="144" text-anchor="middle" class="label">Grafana</text>
  <text x="600" y="162" text-anchor="middle" class="sub">dashboard</text>
