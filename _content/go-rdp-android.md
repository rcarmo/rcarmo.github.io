...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 968 178">
  ...
  <text x="319" y="119" text-anchor="middle" class="label" style="font-size:11px">Media capture</text>
  <text x="319" y="133" text-anchor="middle" class="sub" style="font-size:9px">MediaProjection</text>
