...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 520 150">
  ...
  <text x="380" y="56" text-anchor="middle" class="label">Local State</text>
  <text x="380" y="74" text-anchor="middle" class="sub">CA key + cert</text>



  <text x="260" y="142" text-anchor="middle" class="sub">any HTTP service</text>
</svg>
