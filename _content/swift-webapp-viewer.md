...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 728 178">
  ...
  <text x="120" y="56" text-anchor="middle" class="label">URL config</text>
  <text x="120" y="74" text-anchor="middle" class="sub">plist / CLI arg</text>
  ...
  <text x="364" y="56" text-anchor="middle" class="label">WebKit shell</text>
  <text x="364" y="74" text-anchor="middle" class="sub">WKWebView wrapper</text>
  <rect x="278" y="98" width="82" height="48" rx="6" class="box-purple"/>
  <text x="319" y="119" text-anchor="middle" class="label" style="font-size:11px">Navigation</text>
  <text x="319" y="133" text-anchor="middle" class="sub" style="font-size:9px">URL filtering</text>
  <rect x="368" y="98" width="82" height="48" rx="6" class="box-accent"/>
  <text x="409" y="119" text-anchor="middle" class="label" style="font-size:11px">Key handler</text>
  <text x="409" y="133" text-anchor="middle" class="sub" style="font-size:9px">⌘W · fullscreen</text>

  <rect x="518" y="30" width="180" height="60" rx="8" class="box-orange"/>
  <text x="608" y="56" text-anchor="middle" class="label">Native window</text>
  <text x="608" y="74" text-anchor="middle" class="sub">no browser furniture</text>
