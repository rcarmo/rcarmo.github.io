...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1040 326">
  ...
  <text x="380" y="56" text-anchor="middle" class="label">piku hook</text>
  <text x="380" y="74" text-anchor="middle" class="sub">post-receive</text>

  <rect x="550" y="30" width="180" height="60" rx="8" class="box-green"/>
  <text x="640" y="56" text-anchor="middle" class="label">uwsgi</text>
  <text x="640" y="74" text-anchor="middle" class="sub">process manager</text>

  <rect x="550" y="118" width="180" height="60" rx="8" class="box-green"/>
  <text x="640" y="144" text-anchor="middle" class="label">nginx</text>
  <text x="640" y="162" text-anchor="middle" class="sub">reverse proxy</text>

  <rect x="550" y="206" width="180" height="60" rx="8" class="box-accent"/>
  <text x="640" y="232" text-anchor="middle" class="label">env + deps</text>
  <text x="640" y="250" text-anchor="middle" class="sub">virtualenv / buildpacks</text>

  <rect x="810" y="30" width="180" height="60" rx="8" class="box-orange"/>
  <text x="900" y="56" text-anchor="middle" class="label">Workers</text>
  <text x="900" y="74" text-anchor="middle" class="sub">Procfile</text>

  <rect x="810" y="118" width="180" height="60" rx="8" class="box"/>
  <text x="900" y="144" text-anchor="middle" class="label">TLS + vhosts</text>
  <text x="900" y="162" text-anchor="middle" class="sub">Let's Encrypt</text>

  <rect x="810" y="206" width="180" height="60" rx="8" class="box-green"/>
  <text x="900" y="232" text-anchor="middle" class="label">Any language</text>
  <text x="900" y="250" text-anchor="middle" class="sub">Python / Node / Go</text>
  ...
  <path d="M730,148 L810,148" fill="none" stroke="#5070a0" stroke-width="1.5" stroke-linecap="round" marker-end="url(#ah)"/>
  <path d="M730,236 L810,236" fill="none" stroke="#5070a0" stroke-width="1.5" stroke-linecap="round" marker-end="url(#ah)"/>

  <text x="520" y="318" text-anchor="middle" class="sub">Any POSIX host — Raspberry Pi to cloud VM</text>
</svg>
