...
## Motivation
I feel guilty about neglecting my music hobby and thought this would be a neat way to use my limited free time to cover two or three of my interests. It ended up being an off-beat (ha!) precursor to [`piclaw`](piclaw) instead.
...
### 🔊 Web Audio output
All synthesis runs in the browser through the Web Audio API -- connect to MIDI or use the built-in synths.
